...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4175212,4322482)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4175212,4322482)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37016872,4005175,4031367,45767300,4032522,44810587,44811678,45767299,4308000,44811675,44807726,46270032,763687,37016593)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (37016872,4005175,4031367,45767300,4032522,44810587,44811678,45767299,4308000,44811675,44807726,46270032,763687,37016593)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (766529,756018,704984,794852,19057607,757688,40164052,46275300,35603277,735979,785788,766814,712615,792263,709699,733008,745790,700299,700465,19017241,40230761,703244)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (766529,756018,704984,794852,19057607,757688,40164052,46275300,35603277,735979,785788,766814,712615,792263,709699,733008,745790,700299,700465,19017241,40230761,703244)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (37402410,37402418,37402426,37402402,37402439,37402447,37402455,37402432,37402431,37402381,37402391,37402389,37402397,37402373)

) I
) C UNION ALL 
SELECT 10 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (436073,432590,35610112,4250023,434010)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (436073,432590,35610112,4250023,434010)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (434900,4067987,4100247,35622934,443559,375229,4057246,44782771,380986,4154309,4141292,4034842,36714473,35609824,4322477,35609901,3187953,45757162,45757163,4030431)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (434900,4067987,4100247,35622934,443559,375229,4057246,44782771,380986,4154309,4141292,4034842,36714473,35609824,4322477,35609901,3187953,45757162,45757163,4030431)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (766529,756018,704984,794852,19057607,757688,40164052,46275300,35603277,735979,785788,712615,792263,709699,733008,745790,700299,700465,19017241,40230761,703244)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (766529,756018,704984,794852,19057607,757688,40164052,46275300,35603277,735979,785788,712615,792263,709699,733008,745790,700299,700465,19017241,40230761,703244)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (766843,766844,766848,766849,19095296,35884652)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (766843,766844,766848,766849,19095296,35884652)
  and c.invalid_reason is null
...
WHERE (YEAR(E.start_date) - P.year_of_birth >= 18 and YEAR(E.start_date) - P.year_of_birth <= 40)
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,-30,P.START_DATE) AND A.START_DATE <= DATEADD(day,-1,P.START_DATE) AND A.END_DATE >= DATEADD(day,1,P.START_DATE) AND A.END_DATE <= P.OP_END_DATE ) cc on p.person_id = cc.person_id and p.event_id = cc.event_id
GROUP BY p.person_id, p.event_id
HAVING COUNT(cc.event_id) = 0
-- End Correlated Criteria
